...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for i in 0..<5 {
            ...
            btn.setTitle(typeTitle[i], for: UIControl.State())
            if i == 0 {
        ...
        for i in 0..<3 {
            ...
            btn.setTitle(String(i + 1) + "个", for: UIControl.State())
            if i == 2 {
                btn.backgroundColor = UIColor.red
            } else {
                btn.backgroundColor = UIColor.white
        ...
        startBtn.setTitle("摇一摇", for: UIControl.State())
        startBtn.setTitleColor(UIColor.black, for: UIControl.State())
